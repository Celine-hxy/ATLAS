...
export WANDB_API_KEY=export WANDB_API_KEY=""


project_name='ATLAS'

dataset_name=${1:-"ours_dapo"}
...
exp_name=GRPO_Qwen3-8B-Base_${dataset_name}_${max_response_length}_temp-1.0
...
model_path=$STORAGE/model/Qwen/Qwen3-8B-Base

train_path=$ROOT/ATLAS/results/${dataset_name}.parquet
