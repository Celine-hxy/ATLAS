...
exp_name=GRPO_Qwen3-1.7B-Base_${dataset_name}_${max_response_length}_temp-1.0
...
model_path=$HOME/model/Qwen/Qwen3-1.7B-Base

train_path=$HOME/data/ancestor_data/${dataset_name}/train_instruct.parquet
