...
class CodeforcesProcessor(DatasetProcessor):
    """MatrixStudio/Codeforces-Python-Submissions 数据集处理器"""
    
    def get_default_hf_id(self) -> str:
        return "MatrixStudio/Codeforces-Python-Submissions"
    
    @classmethod
    def get_default_args(cls):
        return {
            "database_root": "$HOME/ATLAS/train/code",
            "prompt_field": "problem-description",
