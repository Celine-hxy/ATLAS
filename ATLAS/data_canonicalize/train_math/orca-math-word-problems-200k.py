...
class OrcaMathWordProblems200KProcessor(DatasetProcessor):
    """microsoft/orca-math-word-problems-200k 数据集处理器"""
    
    def get_default_hf_id(self) -> str:
        return "microsoft/orca-math-word-problems-200k"
...
if __name__ == "__main__":
    processor = OrcaMathWordProblems200KProcessor()
    processor.main()
